...
const projects = [
  {
    title: "Deploying EKS Clusters and Applications with CI/CD using Jenkins and Terraform",
    description: "Automated cloud infrastructure provisioning using Terraform.",
    techStack: ["Terraform", "AWS", "Jenkins"],
    github: "https://github.com/Unnavasriteja/Deploying-EKS-Clusters-and-Applications-with-CI-CD-using-Jenkins-and-Terraform.git",
    demo: "",
    comingSoon: true,
  },
  {
